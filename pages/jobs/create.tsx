    ...
    <Authenticated loading={<Loading />}>
      ...
      <div className="container mx-auto">
        ...
        <div className="job-create flex justify-center">
          <form onSubmit={handleSubmit(submitData)} className="flex flex-wrap gap-y-4 w-full max-w-2xl bg-white rounded shadow-lg p-4 px-4 mt-8 md:p-8 mb-6">
            {/* Company details */}
            <div className="mb-4 w-full">
              ...
              <div className="job-create-section-form gap-y-4 flex flex-col mt-4">
                <div>
                  ...
                  />
                  {errors.companyname && (<span className="text-red-600 text-sm">What is the name of the company?</span>)}
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                  />
                  {errors.companylocation && (<span className="text-red-600 text-sm">A brief address of the company</span>)}
                </div>
                <div>
                  <label htmlFor="companycountry" className="text-sm">
                    Country *
                  </label>
                  <select id="companycountry" {...register("companycountry", {required: true})} className="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
                ...
                {errors.companycountry && (<span className="text-red-600 text-sm">In which country this is located?</span>)}
                </div>
              </div>
            </div>
            ...
            <div className="mb-4 w-full">
              ...
              <div className="job-create-section-form gap-y-4 flex flex-col mt-4">
                <div>
                  ...
                  />
                  {errors.positionname && (<span className="text-red-600 text-sm">What designation you are hiring for?</span>)}
                </div>
                <div>
                  ...
                  {errors.jobcategory && (<span className="text-red-600 text-sm">Select the most appropriate</span>)}
                </div>
                <div>
                  ...
                  {errors.jobtype && (<span className="text-red-600 text-sm">What type of role will this be?</span>)}
                </div>
                <div>
                  ...
                  {errors.experience && (<span className="text-red-600 text-sm">Select the relevant experience required</span>)}
                </div>
                <div>
                  <label htmlFor="experience" className="text-sm">
                    Application URL *
                  ...
                  <input
                    type="text"
                    id="applicationlink"
                    {...register("applicationlink", {required:  {
                        value: true,
                ...
                pattern:{
                    ...
                    className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                  />
                  {errors.applicationlink && (<span className="text-red-600 text-sm">{errors.applicationlink.message}</span>)}
                </div>
                <div>
                  ...
                  <EditorProvider>
                    <Editor
                      value={description}
                      onChange={(e) => {setValue("jobdescription", sanitize(e.target.value)); setDescription(sanitize(e.target.value))}}
                    >
                      <Toolbar>
                        <BtnUndo />
                        <BtnRedo />
                  ...
                  {errors.jobdescription && (<span className="text-red-600 text-sm">A good description is required</span>)}
                </div>
                <div>
                ...
                <div>
                  ...
                  {errors.joblocation && (<span className="text-red-600 text-sm">Select the relevant options</span>)}
                </div>
                <div>
                ...
                <label htmlFor="salary" className="text-sm">
                  ...
                  <input
                    ...
                    className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                  />
                  <span className="text-xs text-gray-400">Example: javascript, python, nodejs, expressjs</span>
                  {errors.tags && (<span className="text-red-600 text-sm block">Enter tags for better visibility</span>)}
                </div>
                <button
                  type="submit"
